...
if __name__ == '__main__':
    ...
    def build_dataloader(phase):
        ...
        if opt.name == 'imagedream' and phase == "train":
            ...
            size = 100
            if cfg.training.strategy == "micro":
                size = cfg.batch_size
            if phase == "val":
                size = 4
    ...
    if cfg.test:
        ...
        max_epoch = np.ceil(cfg.training.iters / (len(train_loader) * train_loader.batch_size * cfg.training.micro_recon_iters)).astype(np.int32)
